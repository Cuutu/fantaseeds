    ...
    <div className="min-h-screen bg-gray-900 pt-20">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gray-900/95 border border-gray-800 rounded-lg p-8 max-w-md w-full mx-4 shadow-xl">
            <div className="flex flex-col items-center">
              <h3 className="text-xl font-bold text-white mb-4">Límite de Membresía Alcanzado</h3>
              ...
              <button
                ...
                className="w-full bg-green-500 hover:bg-green-600 text-white px-6 py-2.5 rounded-lg transition-colors font-medium"
              >
                Aceptar
              </button>
            </div>
